...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  pieCost(recipe, pieQuantity, profitMargin);
}

function pieCost(recipe, pieQuantity, profitMargin) {
  ...
  total(totalCost, pieQuantity, profitMargin);
}

function total(totalCost, pieQuantity, profitMargin) {
